...
class LogisticLoss(LossFunction):
    ...
    def loss(self, Y, Yhat):
        ...
        ### TODO: YOUR CODE HERE
        return sum(log(1 + exp(multiply(multiply(-1,Y), Yhat))))
    ...
    def lossGradient(self, X, Y, Yhat):
        ...
        ### TODO: YOUR CODE HERE
        return - sum(Y * exp(multiply(multiply(-1,Y), Yhat)) / (1 + exp(multiply(multiply(-1,Y), Yhat))) * X.T, axis = 1)
...
class LinearClassifier(BinaryClassifier):
    ...
    def train(self, X, Y):
        ...
        def grad(w):
            ...
            gr   = lossFn.lossGradient(X, Y, Yhat) + (w * lambd)    ### TODO: YOUR CODE HERE
